...
csv_file_path = '/Users/prateekranjan/Documents/Github/openap/workbench/Google_TIM/Basics/CR_THRUST/data/A320/cruise_thrust_A320-214.csv'
...
cbar.set_label('Cruise Thrust (kN)', fontsize=20, fontname="Times New Roman") #weight='bold')  # Colorbar title
...
plt.savefig('data/A320/A320-214_CRZ_Contour.png', dpi=300)  # Save the figure
plt.show()
