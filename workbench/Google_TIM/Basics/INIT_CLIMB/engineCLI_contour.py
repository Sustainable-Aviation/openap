...
csv_file_path = '/Users/prateekranjan/Documents/Github/openap/workbench/Google_TIM/Basics/INIT_CLIMB/data/A320/ini_clmb_thrust_A320-214.csv'
#csv_file_path = '/Users/prateekranjan/Documents/Github/openap/workbench/Google_TIM/Basics/INIT_CLIMB/data/A320/cruise_thrust_A320-215.csv'
...
altitudes = np.array(altitudes) * 1e-03
...
# Set the limits for the color mapping
vmin, vmax = 82, 120  # Set your desired limits here

# Generate contour plot
contour = plt.contourf(alt_grid, speed_grid, thrust_grid, levels=50, cmap='coolwarm',vmin=vmin, vmax=vmax)

# Add colorbar and its title
cbar = plt.colorbar(contour)

cbar.set_label('Climb Thrust (kN)', fontsize=20, fontname="Times New Roman") #weight='bold')  # Colorbar title
...
plt.savefig('data/A320/A320-214_ICLM_Contour.png', dpi=300)  # Save the figure
plt.show()
